...
- Global Email Design Templates module with the built-in Virtuprose Signature Premium template, custom HTML template creation, desktop/mobile preview, test-send flow, and campaign-level selection.
